export const LESes = {
    section1: [
        {
            ...
            videoSummary: "A beginner-friendly introduction to Python programming, covering installation, syntax, and basic concepts."
        },
        {
            Head: "Lesson 1.2",
            ...
            videoSummary: "A clear explanation of Python's core data structures: lists, tuples, and dictionaries, with practical examples."
        ...
        },
        {
            ...
            videoSummary: "Learn how to use if statements, loops, and functions in Python to control program flow and reuse code."
    ...
    section2: [
        {   
            ...
            videoSummary: "A complete Python tutorial for beginners, covering syntax, file structure, and essential programming concepts."
        ...
        },
        {
            ...
            videoSummary: "Step-by-step guide to installing Python and setting up your development environment, including IDE recommendations."
        ...
        },
        {
            ...
            paragraph1: "This lesson guides you through installing Python on your system and configuring your development environment. You'll learn about popular IDEs like VS Code and PyCharm and how to install necessary extensions and packages.",
            paragraph2: "Furthermore, we cover the usage of virtual environments to manage dependencies and streamline project development. With these tools, you'll be ready to dive into programming with Python.",
            videoUrl: "https://www.youtube.com/watch?v=U2ZN104hIcc",
            videoSummary: "Learn how to use Python virtual environments to manage dependencies and keep your projects organized."
        },
        {
            Token: '+3 Tokens'
        },
